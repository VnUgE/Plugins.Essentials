...
* File: IUserFieldSerializer.cs 
*
* IUserFieldSerializer.cs is part of VNLib.Plugins.Essentials.Users which is part of the larger 
...
{
    internal interface IUserFieldSerializer
    {
        void StoreFields(UserEntry userEntry, UserExtendedFields fields);

        UserExtendedFields? GetFields(UserEntry userEntry);
    }
}