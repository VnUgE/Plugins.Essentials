...
* File: OidcNewUserDataResult.cs 
*
* OidcNewUserDataResult.cs is part of VNLib.Plugins.Essentials.Auth.Social which 
...
{
    internal sealed class OidcNewUserDataResult
    {
